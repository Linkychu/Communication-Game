...
namespace General
{
    ...
    public class DamageManager : MonoBehaviour
    {
        ...
        public int DamageCalculator(int skillDamage, int BaseAttack, int EnemyBaseHp, int EnemyDefence, int BaseSpecialAttack, int EnemySpecialDefence, float AttackModifier, float DefenseModifier, float SpecialAttackModifier, MoveType type, Affinities affinity, Affinities enemyAffinity , int BaseLevel, int enemyLevel, float enemyDefenseModifier, float EnemySpecialDefenceModifier)
        {
            ...
            int  attackDefRatio = type == MoveType.Physical ? Mathf.FloorToInt( (BaseAttack * AttackModifier) / EnemyDefence * enemyDefenseModifier) : Mathf.FloorToInt((BaseSpecialAttack * SpecialAttackModifier) / EnemySpecialDefence * EnemySpecialDefenceModifier);
